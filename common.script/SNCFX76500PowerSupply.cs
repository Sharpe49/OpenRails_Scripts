...
{
    /// <summary>
    /// Power supply for French Diesel multiple unit with MU control and dynamic braking.
    /// For example, it is appropriate for X 76500 multiple unit.
    /// </summary>
    public class SNCFX76500PowerSupply : DieselPowerSupply
    {
