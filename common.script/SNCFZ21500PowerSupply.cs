...
{
    /// <summary>
    /// Power supply for French electric multiple unit with voltage selector.
    /// For example, it is appropriate for Z 21500 multiple unit.
    /// </summary>
    public class SNCFZ21500PowerSupply : ElectricPowerSupply
    {
