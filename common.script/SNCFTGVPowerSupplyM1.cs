...
namespace ORTS.Scripting.Script
{
    ...
    /// </summary>
    public class SNCFTGVPowerSupplyM1 : ElectricPowerSupply
    {
        [Flags]
        ...
        public LocomotiveNumber LocomotiveLeading = LocomotiveNumber.M1;
        ...
        public override void Initialize()
        {
            ...
            LocomotiveLeading = IsLocomotiveLeading ? LocomotiveNumber.M2 : LocomotiveNumber.M1;
        ...
        protected void UpdatePantographCommand()
        {
            ...
            if (IsLocomotiveLeading && LocomotiveLeading == LocomotiveNumber.M1)
            {
                if (CurrentCabPowerSupplyState() != PowerSupplyState.PowerOn
                    || LowerPantograph
