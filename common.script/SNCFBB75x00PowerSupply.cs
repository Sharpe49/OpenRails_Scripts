...
{
    /// <summary>
    /// Power supply for French Diesel locomotives with MU control and dynamic braking.
    /// For example, it is appropriate for BB 75000 locomotives.
    /// </summary>
    public class SNCFBB75x00PowerSupply : DieselPowerSupply
    {
